...
public class LoginScreen {
	...
	public static void login(WebDriver driver, String email, String password, String expectErrMsg) {
		...
		else if (expectErrMsg == EMPTY_EMAIL_MSG || expectErrMsg == EMPTY_PASSWORD_MSG) {
